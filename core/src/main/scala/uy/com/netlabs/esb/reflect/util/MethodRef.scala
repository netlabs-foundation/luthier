package uy.com.netlabs.esb.reflect.util
...
object MethodRef {
  ...
  object MethodRefMacros {
    def methodRefImpl0[ClassRef: c.AbsTypeTag, R: c.AbsTypeTag](c: Context)(f: c.Expr[() => R]) = impl[ClassRef, Unit, R](c)(f)
    def methodRefImpl1[ClassRef: c.AbsTypeTag, P1: c.AbsTypeTag, R: c.AbsTypeTag](c: Context)(f: c.Expr[P1 => R]) = impl[ClassRef, P1, R](c)(f)
    def methodRefImpl2[ClassRef: c.AbsTypeTag, P1: c.AbsTypeTag, P2: c.AbsTypeTag, R: c.AbsTypeTag](c: Context)(f: c.Expr[(P1, P2) => R]) = impl[ClassRef, (P1, P2), R](c)(f)
    def methodRefImpl3[ClassRef: c.AbsTypeTag, P1: c.AbsTypeTag, P2: c.AbsTypeTag, P3: c.AbsTypeTag, R: c.AbsTypeTag](c: Context)(f: c.Expr[(P1, P2, P3) => R]) = impl[ClassRef, (P1, P2, P3), R](c)(f)
    def methodRefImpl4[ClassRef: c.AbsTypeTag, P1: c.AbsTypeTag, P2: c.AbsTypeTag, P3: c.AbsTypeTag, P4: c.AbsTypeTag, R: c.AbsTypeTag](c: Context)(f: c.Expr[(P1, P2, P3, P4) => R]) = impl[ClassRef, (P1, P2, P3, P4), R](c)(f)
    def methodRefImpl5[ClassRef: c.AbsTypeTag, P1: c.AbsTypeTag, P2: c.AbsTypeTag, P3: c.AbsTypeTag, P4: c.AbsTypeTag, P5: c.AbsTypeTag, R: c.AbsTypeTag](c: Context)(f: c.Expr[(P1, P2, P3, P4, P5) => R]) = impl[ClassRef, (P1, P2, P3, P4, P5), R](c)(f)
    def methodRefImpl6[ClassRef: c.AbsTypeTag, P1: c.AbsTypeTag, P2: c.AbsTypeTag, P3: c.AbsTypeTag, P4: c.AbsTypeTag, P5: c.AbsTypeTag, P6: c.AbsTypeTag, R: c.AbsTypeTag](c: Context)(f: c.Expr[(P1, P2, P3, P4, P5, P6) => R]) = impl[ClassRef, (P1, P2, P3, P4, P5, P6), R](c)(f)

    private def impl[ClassRef: c.AbsTypeTag, ArgumentList: c.AbsTypeTag, ReturnType: c.AbsTypeTag](c: Context)(f: c.Expr[_]): c.Expr[MethodRef[ClassRef, ArgumentList, ReturnType]] = {
      import c.universe._
      val classRefType = implicitly[c.AbsTypeTag[ClassRef]]
