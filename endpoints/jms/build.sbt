libraryDependencies ++= Seq(
  ...
  "org.apache.activemq" % "activemq-pool" % "5.11.1" % "optional" exclude("log4j", "log4j"),
  "org.slf4j" % "slf4j-log4j12" % "1.7.12" % "optional" exclude("log4j", "log4j"),
  "log4j" % "log4j" % "1.2.17" % "optional"// attempt to fix the broken maven dependency
)
